import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as n,e as d}from"./app.bf1fe36d.js";const s={},l=d(`<h3 id="c-typedef用法" tabindex="-1"><a class="header-anchor" href="#c-typedef用法" aria-hidden="true">#</a> C++typedef用法</h3><p>1</p><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>    typedef int size;
    size first_num=1;
    size(third)=8;
    int second_num=2;
